...
const char* ssid = "Winnieflute"; //remember change your SSID 
const char* password = "wfwfwfwf";// remember change your SSID PW
...
void loop() {
  ...
  delay(1000);
  wifisendfile("/pic" + String(i) +".jpg",host,url+"?azureURL=" + azureURL + "&azureKEY=" + azureKEY );
  delay(10000);
}
